...
\begin{center}
  ...
  \captionof{figure}{fiat --- Es geschehe}
...
\begin{center}
  ...
  \captionof{figure}{Eine uralte Münze: Die Lydische Elektron-Trite. Bild: cc-by-sa Classical Numismatic Group, Inc.}
...
\begin{center}
  ...
  \captionof{figure}{Unterschiedlich stark gefeilte Silbermünzen}
...
\begin{center}
  ...
  \captionof{figure}{Der ursprüngliche \enquote{Dollar}. Bild: cc-by-sa Wikipedia-User Berlin-George.}
...
\begin{center}
  ...
  \captionof{figure}{Ein Silberdollar von 1928 in den USA. \enquote{Auf Verlangen an den
...
\begin{center}
  ...
  \captionof{figure}{Ein U.S. Goldzertifikat im Wert von \$100 aus dem Jahre 1928. Bild:
...
\begin{center}
  ...
  \captionof{figure}{Eine 2004er Serie von 20-Dollar-Noten in den USA, die heute verwendet
