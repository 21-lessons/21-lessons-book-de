...
die einzigen zukünftigen Menschen mit denen du über Wirtschaft diskutieren
...
gab Leute, die sich buchstäblich so viel von ihrer Münze abfeilten, wie sich
\enquote{erlauben} konnten ohne erwischt zu werden. Ich stelle mir allerdings
die Frage, wie damals eigentlich die Werbung des Unternehmens \enquote{Dollar
Shave Club} aussah.
...
die eigenen Bürger zu stoppen. In der klassischen Räuber und Gendarme Manier
...
\begin{figure}
  ...
  \caption{Der ursprüngliche \enquote{Dollar}. Der heilige Joachim ist mit seinem Gewand und seinem Zauberhut abgebildet.
Bild: cc-by-sa Wikipedia-User Berlin-George.}
...
einer kleineren Zahl beliebig unterteilt werden kann, ist es einfacher es in
kleinere Einheiten zu zerlegen.
...
vollständig zu durchbrechen: Die Abschaffung des Goldstandards und jeden davon
...
Trick in der Geschichte der Wirtschaft: Das Fiatgeld.}
