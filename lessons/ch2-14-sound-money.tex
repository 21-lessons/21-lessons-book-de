...
\begin{center}
  ...
  \end{equation}
  \captionof{figure}{Die Formel für die Angebotsmenge von Bitcoin}
...
\begin{center}
  ...
  \captionof{figure}{Die kontrollierte Ausschüttung von Bitcoin}
...
\begin{center}
  ...
  \end{equation}
  \captionof{figure}{Stock-to-Flow Verhältnis von Gold}
...
\begin{center}
  ...
  \captionof{figure}{Die Visualisierung des Stock-to Flow Modells für Fiat, Gold und Bitcoin}
...
\begin{center}
  ...
  \captionof{figure}{Steigendes Stock-to-Flow-Verhältnis von Bitcoin im Vergleich zu Gold}
