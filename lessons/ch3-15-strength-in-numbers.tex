...
\begin{center}
  ...
  \captionof{figure}{Dicke der Eisschichten vor ungefähr einer Billion Sekunden. Quelle: xkcd 1225}
  \label{fig:xkcd-1225}
\end{center}
...
\begin{center}
  ...
  \captionof{figure}{Illustration von den Sicherheitsgarantien von SHA-256. Grafik aus dem Video von Grant Sanderson / 3Blue1Brown.}
...
\begin{center}
  ...
  \captionof{figure}{\$5-Schraubenschlüsselangriffs. Quelle: xkcd 538}
  \label{fig:xkcd-538}
\end{center}
...
\begin{center}
  ...
  \captionof{figure}{Grafische Darstellung elliptischer Kurven. Bild: cc-by-sa Emmanuel Boutet.}
